...
enum InterviewSessionState { connecting, ready, speaking, listening }
...
class SessionStatusPill extends StatelessWidget {
  ...
  static (String, Color, bool) _stateProps(InterviewSessionState state, AppLocalizations? l) {
    switch (state) {
      case InterviewSessionState.connecting:
        return (l?.interviewStatusConnecting ?? 'Đang kết nối với examiner...', const Color(0xFFF59E0B), true);
      ...
      case InterviewSessionState.speaking:
        return (l?.interviewStatusSpeaking ?? 'Examiner đang nói', const Color(0xFFFF6A14), false);
      case InterviewSessionState.listening:
        return (l?.interviewStatusListening ?? 'Đang lắng nghe bạn...', const Color(0xFF22C55E), true);
    }
  }
}
