  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: '16px 10px', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ padding: '8px 12px', borderRadius: 'var(--r2)', background: 'rgba(255,255,255,0.06)' }}>
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', letterSpacing: 0.4, fontWeight: 600, marginBottom: 2 }}>VERSION</div>
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.55)' }}>A2 Mluveni Sprint v1</div>
        </div>
      </div>
    </aside>
  );
